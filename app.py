...
# Function to process the uploaded file and return the field areas
...
st.write("Upload a CSV file with 'lat', 'lng', and 'Timestamp' columns to calculate field areas and visualize them.")

uploaded_file = st.file_uploader("Choose a CSV file", type="csv")

if uploaded_file is not None:
    st.write("Processing file...")
    combined_df = process_file(uploaded_file)
    ...
    if combined_df is not None:
        ...
        st.write("Alternatively, view the map [here](https://flashop59.github.io/map-hosting/)")  # Update with your GitHub Pages URL
    else:
